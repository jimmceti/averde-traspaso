...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        convertDataStructureToTable: function (fields) {
            var $fields = fields
            var result = "<table>";
            ...
            $(this.gridData).each(function (key, value) {
                result += "<tr>";
        ...
        exportar: function (htmltable) {
            ...
            var ctx = { worksheet: "hoja1", table: htmltable };

            return (uri + this.base64(this.format(excelFile, ctx)));
        },
        exportarExcel: function (objeto) {
            //console.log(this);
            this.gridData = this.data;

            this.excelData = this.exportar(this.convertDataStructureToTable(this.fields));

            if (false) {
                return this.excelData;
            }
            else {
                window.location.href = this.excelData;
